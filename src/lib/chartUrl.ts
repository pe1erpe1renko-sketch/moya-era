 ...
 *
 * Вопрос картам (`q` на /taro) — тоже личный текст: страница забирает
 * его из адреса и стирает, но в статистику он не должен попасть даже за
 * ту секунду, что был в адресной строке.
 *
 ...
 */
export const PRIVATE_PARAMS = ["n", "q"];
