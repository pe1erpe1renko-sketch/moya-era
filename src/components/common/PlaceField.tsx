      ...
      {hint && (
        <p className="mt-1.5 text-[12px] leading-snug text-text-secondary" aria-live="polite">
          {value
            ...
            : notFound
              ? "В справочнике не нашлось. Сохраним как текст, но без координат дома и асцендент не посчитаются. Попробуй ближайший город"
              : "Начни вводить название и выбери из списка"}
        </p>
      )}
    </div>
  );
