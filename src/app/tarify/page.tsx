...
const FAQ = [
  {
    ...
    a: "Нет, отдельные разборы не продаются. Подписка открывает всё сразу: все шесть систем по датам ваших людей, каждый вопрос в каждом разборе, карту дня с историей, сводку в Telegram и архив. Так проще: не нужно решать, за какой разбор платить.",
  },
  {
