...
const SAMPLE_PARAGRAPHS = [
  "Седьмое число пути ставит человека в положение наблюдателя раньше, чем участника. Вы сначала разбираетесь, как устроено, и только потом входите — и это не осторожность, а способ, которым вы вообще способны действовать. Попытки заставить себя «просто начать» обычно заканчиваются откатом.",
  "В квадрате при этом важна не сама семёрка, а её плотность. Две семёрки в вашей дате означают, что интерес к устройству вещей достаточно силён, чтобы быть профессией, но не настолько, чтобы вытеснять всё остальное.",
  "Отдельного внимания заслуживает пустая ячейка на пятёрке. Отсутствующая цифра не означает нехватки — она означает, что это качество не встроено по умолчанию и набирается опытом. В вашем случае это касается того,",
];
  ...
  return (
    ...
    >
      <div className="mx-auto w-full max-w-[1240px] px-[4vw] md:px-6">
        ...
        >
          {ctx ? "Ваш квадрат Пифагора" : "Квадрат Пифагора"}
        </h2>
        <p
          className="text-text-secondary"
...
export default function NumerologyPage() {
  return (
    <DirectionPage<NumerologyResult>
      ...
      finalTitle="Посчитайте свои числа"
